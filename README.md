...
请参照 [Installation](./install.md) 配置实验所需环境。
...
python tools/train.py --config_file configs/ms1mv2_mobileface.py --embedding_size 128 --sample_ratio 1.0 --loss ArcFace --batch_size 256 --dataset MS1M_v2 --num_classes 1000 --data_dir F:\face_datasets_1000 --label_file F:\face_datasets_1000/label.txt --fp16 False
```
<a name="单机8卡"></a>
